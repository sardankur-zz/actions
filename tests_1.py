...
def test_classify_Q():
    ...
    trainFile = "data/amazon/question_train1.txt"
    testFile = "data/amazon/question_test1.txt"
    ...
    trainData = dataset.extract_list(train, 2)
    trainTarget = dataset.extract_list(train, 0)

    #       - testing data
    test = dataset.get_data(testFile)
    testData = dataset.extract_list(test, 2)
